...
print "memory.type(string), memory:set(i, d), memory:get(i)"
...
do print "memory.create(string), memory.diff, memory.len, #memory"
...
do print "memory.create(memory|string [, i [, j]])"
...
do print "memory:fill(string [, i [, j]])"
